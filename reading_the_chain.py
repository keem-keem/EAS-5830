...
def get_contract_values(contract, admin_address, owner_address):
	...
	onchain_root = 0  contract.functions.merkleRoot().call() # Get and return the merkleRoot from the provided contract
	has_role = 0  contract.functions.hasRole(default_admin_role, admin_address).call() # Check the contract to see if the address "admin_address" has the role "default_admin_role"
	prime = 0  contract.functions.getPrime(owner_address).call() # Call the contract to get the prime owned by "owner_address"
